...
// Generated Mar 6, 2018 12:51:01 AM by Hibernate Tools 4.3.1
 ...
 */
@Entity
@Table(name = "USER", catalog = "NSRP_CATER")
public class User implements java.io.Serializable {
	...
	public User(String username, String fullname, String password, String restoreCode, String staffId, String stations,
			String trans, Date lastUpdate, String MDepts, String smtpemail, boolean status, String langType) {
		this.username = username;
		this.fullname = fullname;
		this.password = password;
