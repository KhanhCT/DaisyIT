...
public class CateringId  implements java.io.Serializable {
	...
	private String staffId;
     private char mealTtme;
     private Date caterDate;

    public CateringId() {
    }

    public CateringId(String staffId, char mealTtme, Date caterDate) {
    ...
    @Column(name="MEAL_TTME", nullable=false, length=1)
    public char getMealTtme() {
        return this.mealTtme;
    }
    
    public void setMealTtme(char mealTtme) {
        this.mealTtme = mealTtme;
    }
 ...
 && (this.getMealTtme()==castOther.getMealTtme())
 && ( (this.getCaterDate()==castOther.getCaterDate()) || ( this.getCaterDate()!=null && castOther.getCaterDate()!=null && this.getCaterDate().equals(castOther.getCaterDate()) ) );
   ...
   public int hashCode() {
         ...
         result = 37 * result + this.getMealTtme();
