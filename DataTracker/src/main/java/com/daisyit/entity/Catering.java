...
// Generated Mar 6, 2018 2:26:40 AM by Hibernate Tools 4.3.1
 ...
 */
@Entity
@Table(name = "CATERING", catalog = "NSRP_CATER")
public class Catering implements java.io.Serializable {
	...
	public Catering(CateringId id, String mealId, String zoneSymb, String shift, boolean catered, String caterTime,
			boolean status, String wsId, String userId, Date openDate, Date modiDate) {
		this.id = id;
		this.mealId = mealId;
