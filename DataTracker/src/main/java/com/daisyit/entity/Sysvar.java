 ...
 */
@Entity
@Table(name = "SYSVAR", catalog = "NSRP_CATER")
public class Sysvar implements java.io.Serializable {
	...
	*/
	...
	public Sysvar(String name, char type, String value, String descript, String inputmask, byte modify, String invalid,
			char depCode, int rsrId) {
		this.name = name;
		this.type = type;
		this.value = value;
