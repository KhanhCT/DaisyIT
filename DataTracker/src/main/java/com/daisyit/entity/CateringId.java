...
public class CateringId implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof CateringId))
			return false;
		...
		return ((this.getStaffId() == castOther.getStaffId()) || (this.getStaffId() != null
				...
				&& ((this.getMealTtme() == castOther.getMealTtme()) || (this.getMealTtme() != null
						&& castOther.getMealTtme() != null && this.getMealTtme().equals(castOther.getMealTtme())))
				&& ((this.getCaterDate() == castOther.getCaterDate()) || (this.getCaterDate() != null
						&& castOther.getCaterDate() != null && this.getCaterDate().equals(castOther.getCaterDate())));
	}
