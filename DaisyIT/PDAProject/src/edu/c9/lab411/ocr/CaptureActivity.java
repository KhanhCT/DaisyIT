...
import edu.c9.lab411.ocr.camera.CameraManager;
import edu.c9.lab411.ocr.camera.ShutterButton;
import edu.c9.lab411.ocr.language.LanguageCodeHelper;
import edu.c9.lab411.ocr.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements
	...
	public void onCreate(Bundle icicle) {
		...
		// dang ky mot context menu hien thi nhieu item khi nhan vao no
	...
	private File getStorageDirectory() {
		...
		if (Environment.MEDIA_MOUNTED.equals(Environment
			...
			// example,
			// // "/mnt/sdcard/Android/data/edu.c9.lab411.ocr/files/"
			// return new
